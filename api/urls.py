...
from .views import get_response, post_response,post_response_to_frontend,add_student,get_studentdata,get_onestudentdata,get_onestudentdata_withparameter,get_samename_studentdata_withparameter,update_student_data# ye step 4 hai... function ko import kea hai yahan
urlpatterns = [
    ...
    #get ka path hai /api/
     ...
     path('getsamestudentdata/<str:name>/', get_samename_studentdata_withparameter ),
     path('updatestudentdata/<int:id>/', update_student_data ),
